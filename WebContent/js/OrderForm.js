...
// List all address components (corresponds to form field IDs and Google address
// object)
var componentForm = {
...
function fillInAddress() {
   ...
   // Enable each field, then fill them with the corresponding value from the
   // place object
   ...
   // Search the passed object for a specified address component/type and return
   // the short_name value of the matched component/type
   // If requested type does not exist in the placeObject, return an empty
   // string
